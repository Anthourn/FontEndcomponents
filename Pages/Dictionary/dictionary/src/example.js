const definition = [
        ...
        sseq: [
          [
                ...
                [
                  "bs",
                  {
                    sense: {
                      sn: "1 a",
                      dt: [
                        ["text", "{bc}a means of {a_link|testing}: such as"],
                      ],
                    },
                  },
                ],
            ...
            [
              ...
              {
                sn: "b",
                dt: [["text", "{bc}a positive result in such a test"]],
              },
            ],
          ],
          [
          ...
          [
            [
              ...
              {
                sn: "3",
                dt: [["text", "{bc}a result or value determined by testing"]],
              },
            ],
          ],
          [
        ...
        sseq: [
            ...
            [
              "sense",
              {
                ...
                dt: [
                  ...
                  ["uns", [[["text", "often used with {it}out{/it}"]]]],
                ],
              },
            ],
          ],
          [
            [
              ...
              {
                sn: "2",
                dt: [["text", "{bc}to require a doctrinal oath of"]],
              },
            ],
          ],
        ],
        ...
        sseq: [
          [
            [
              ...
              {
                sn: "1",
                dt: [["text", "{bc}of, relating to, or constituting a test"]],
              },
            ],
          ],
          [
  ...
  },
  {
    ...
    et: [["text", "Latin {it}testa{/it} shell"]],
    date: "circa 1842",
    shortdef: [
